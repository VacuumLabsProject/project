...
from real_sputtering.calculation import sputtering_calculation, \
    calculating_things, sputtering_coefficient_calculation
import edit_while_chamber_is_open
import vacuum_system
from real_sputtering.qt_py.diploma_sputtering import Ui_Form
...
class MainWindow(QtWidgets.QMainWindow, Ui_Form):
    ...
    def open_chamber_but(self):
        ...
        if self.S == "No such pair":
            ...
            self.Ecv = self.S[5]
            self.S = self.S[0]
            self.Lk_and_Lambda = calculating_things.calculating_h(T, self.M1,
                                                            self.M2, d1, d2,
                                                            self.Ecv,
                                                            self.goal_pressure)
