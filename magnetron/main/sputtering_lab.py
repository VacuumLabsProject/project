...
from magnetron.calculation import sputtering_calculation, sputtering_coefficient_calculation, calculating_things
import edit_while_chamber_is_open
import vacuum_system
from magnetron.qt_py.diploma_sputtering import Ui_Form
